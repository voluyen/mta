...
SAVE_PATH="${BASE_PATH}/results/${CKPT_NAME}#amid/${AMID_DIV_NAME}_${AMID_DIV_ORDER}_${AMID_ALPHA}_${AMID_LAM}_${BATCH_SIZE}_${LR}_wo_weight"
...
# ablation: disable token importance weighting (uniform mean pooling)
OPTS+=" --no-span-weight"
