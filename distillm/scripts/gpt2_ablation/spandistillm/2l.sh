...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2_ablation/spandistillm/2l"
# seed
SEED=42
...
OPTS+=" --teacher_layer_mapping 36 48"
OPTS+=" --student_layer_mapping 9 12"
OPTS+=" --split_layer_mapping 0 1 2 2"
OPTS+=" --use_hs"
OPTS+=" --use_dsa"
