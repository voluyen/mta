...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/spanfdd_3b"
# seed
SEED=42
...
# OPTS+=" --teacher-peft-path distillm/results/qwen3-8B-lora"
# deepspeed
OPTS+=" --deepspeed"
...
OPTS+=" --teacher_layer_mapping 16 20 24 28"
OPTS+=" --student_layer_mapping 24 28 32 36"
