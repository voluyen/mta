...
TEACHER_MODEL_NAME="qwen2.5"
TEACHER_MODEL_PATH="VoCuc/Qwen2.5-7B-Instruct-Dolly-SFT"
# data
...
#MTA
OPTS+=" --MTA-mode"
OPTS+=" --teacher_layer_mapping 7 14 18 21 25 28"
OPTS+=" --student_layer_mapping 8 16 20 24 28 32"
