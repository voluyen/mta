...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5/spandistillm_3b"
# seed
SEED=42
...
OPTS+=" --teacher-peft-path distillm/results/qwen3/8B_sft/e3-bs4-lr5e-05-G4-N2-NN1-lora-16-32-0.1/714"
# deepspeed
OPTS+=" --deepspeed"
...
OPTS+=" --teacher_layer_mapping 26 28 30 32 34 36"
OPTS+=" --student_layer_mapping 26 28 30 32 34 36"
OPTS+=" --split_layer_mapping 0 3 6 6"
