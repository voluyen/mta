...
def add_ab_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--ab_alpha", type=float, default=0.5)
    group.add_argument("--ab_beta", type=float, default=0.5)
...
def add_amid_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--amid-div-name", type=str, default="fkl")
    group.add_argument("--amid-div-order", type=str, default="pr")
...
def get_args():
    ...
    if args.type == "eval_main":
        ...
        save_path = os.path.join(
            args.save,
            f"{args.data_names}-{args.max_length}" + (
