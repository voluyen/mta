...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen1.5/spandistillm_a4"
# seed
SEED=42
...
OPTS+=" --teacher_layer_mapping 12 14 16 18 20 22 24"
OPTS+=" --student_layer_mapping 12 14 16 18 20 22 24"
OPTS+=" --split_layer_mapping 0 3 7 7"
