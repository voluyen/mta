...
MAX_LENGTH=256
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2_ablation/spandistillm/4l3"
# seed
SEED=42
...
OPTS+=" --teacher_layer_mapping 12 24 36 48"
OPTS+=" --student_layer_mapping 3 6 9 12"
OPTS+=" --split_layer_mapping 0 3 4 4"
OPTS+=" --use_hs"
OPTS+=" --use_dsa"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/ablation_span_finetune.py ${OPTS} $@"
